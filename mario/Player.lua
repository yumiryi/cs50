...
function Player:render()
    ...
    if self.map:tileAt(self.x + self.width, self.y).id == (FLAGPOLE_BOTTOM or FLAGPOLE_MID or FLAGPOLE_TOP) or
        self.map:tileAt(self.x + self.width, self.y + self.height - 1).id == (FLAGPOLE_BOTTOM or FLAGPOLE_MID or FLAGPOLE_TOP) or 
        self.map:tileAt(self.x, self.y + self.height).id == FLAGPOLE_TOP or
        self.map:tileAt(self.x + self.width - 1, self.y + self.height).id == FLAGPOLE_TOP then
        ...
        love.graphics.printf('You win!',
            map.camX, VIRTUAL_WIDTH / 4, VIRTUAL_WIDTH, 'center')
    end
end
